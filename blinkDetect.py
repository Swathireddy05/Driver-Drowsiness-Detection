"""
TODO:
    - Improve face landmark detection. Probably caused due to lighting changes. Eliminate the effect of lightinh with
      minimal computation.
...
def checkBlinkStatus(eye_status):
...
while validFrames < dummyFrames:
    ...
    if landmarks == 0:
        ...
        cv2.putText(frame, "or decrease FACE_DOWNSCALE_RATIO", (10, 50), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1,
                    cv2.LINE_AA)
        ...
        # cv2.LINE_AA) cv2.show("Blink Detection Demo", frame)
    ...
    while 1:
        try:
            ...
            if landmarks == 0:
                ...
                cv2.putText(frame, "or decrease FACE_DOWNSCALE_RATIO", (10, 50), cv2.FONT_HERSHEY_COMPLEX, 0.5,
